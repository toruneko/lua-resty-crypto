...
--- config
    location /t {
        content_by_lua_block {
            $TEST_NGINX_PK_CONF
            local resty_rsa = require "resty.rsa"
            local rsa_public_key, rsa_private_key, err = resty_rsa.generate_key(2048)
...
--- config
    location /t {
        content_by_lua_block {
            $TEST_NGINX_PK_CONF
            local resty_rsa = require "resty.rsa"
            local rsa_public_key, rsa_private_key, err = resty_rsa.generate_key(2048, true)
...
--- config
    location /t {
        content_by_lua_block {
            $TEST_NGINX_PK_CONF
            local resty_rsa = require "resty.rsa"
            local rsa_public_key, rsa_private_key, err = resty_rsa.generate_key(0)
